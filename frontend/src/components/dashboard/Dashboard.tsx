...
import { Brain, Play, Trophy, ClipboardList, LogOut, Lightbulb, Sparkles } from 'lucide-react';
            ...
            {hasPlayed && score !== null ? (
              ...
              <motion.div className="space-y-6">
                ...
                <Button
                  onClick={onViewLeaderboard}
                  variant="ghost"
                  className="w-full h-10 text-muted-foreground hover:text-foreground hover:bg-primary/10"
                >
